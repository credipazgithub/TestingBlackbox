...
<div class="container-full m-0 p-1">
    <h2 style="text-align:left;margin:0px;padding:0px;font-size:22px;font-weight:bold;color:#dd127b;font-family: 'Poppins-Bold' !important;">Informe de actividad de cobros en plataformas externas</h2>        
    ...
    <div class="row datos-informados m-0 mt-2 p-1 d-none"></div>
</div>

<script>
    $.getScript('./application/views/mod_payments/transactions/form.js', function() {

...
<div class="container-full m-0 p-1">
    <h2 style="text-align:left;margin:0px;padding:0px;font-size:22px;font-weight:bold;color:#dd127b;font-family: 'Poppins-Bold' !important;">Indicadores de marketing MEDIYA</h2>        
...
<script>
    $.getScript('./application/views/mod_marketing/transactions_mediya/form.js', function() {

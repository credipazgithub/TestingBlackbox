...
<div class="container-full m-0 p-1">
    <h2 style="text-align:left;margin:0px;padding:0px;font-size:22px;font-weight:bold;color:#dd127b;font-family: 'Poppins-Bold' !important;">Indicadores de Operaciones</h2>        
...
<div class="container datos-informados m-0 mt-2 p-1 d-none"></div>

<script>
    $.getScript('./application/views/mod_onboarding/informes/form.js', function() {
        /* Seguir implementación desde acá, empezando por indicadores simples por tipo producto, estado, sucursal, etc... */
	});
</script>

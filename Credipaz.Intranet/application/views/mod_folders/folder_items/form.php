...
-->
        ...
        <script type="text/javascript" src="../assets/js/_third/barcode.js"></script>
    ...
    <body>
        <div class="container">
            <p class="pt-2"><img src="https://intranet.credipaz.com/assets/credipaz/img/small.png" style="height:38px;"></p>
            <p class="p-2 m-2 shadow"><?php echo $body;?></p>
            <h2 class="pt-2"><?php echo $title;?></h2>
        </div>
    </body>
</html>

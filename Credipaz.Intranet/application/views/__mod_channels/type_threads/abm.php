...
$html.="<div class='form-row'>";
$html.=getInput($parameters,array("col"=>"col-md-2","name"=>"skip_blacklist","type"=>"checkbox","class"=>"form-control text dbase"));
$html.=getInput($parameters,array("col"=>"col-md-2","name"=>"hidden","type"=>"checkbox","class"=>"form-control text dbase"));
$html.="</div>";

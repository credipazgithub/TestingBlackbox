        ...
        <div class="d-flex" style="height:50px;border-bottom:2px solid black;">
            <div class="col-12 ml-auto m-auto p-auto" style="max-height:47px;">
                <div class="float-right status-ajax-calls d-none p-0 m-0">
                    ...
                    <a href="./tiendamil" class="btn btn-raised btn-sm btn-logout"><i class='material-icons'>logout</i></a>
                </div>
            </div>
        </div>
...
<script>
   ...
   if(_allow==""){
      alert("No tiene permisos de acceso como vendedor/a de Tienda MIL");
	  window.location="./tiendamil";
   } else {
	  $("."+_allow).click();
   }
</script>

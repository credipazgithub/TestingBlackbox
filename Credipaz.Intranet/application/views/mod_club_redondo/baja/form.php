...
<div class="mt-4 form-alta container marco text-center">
    <h2 class="nd-asociate mb-2" style="color:rgb(0, 71, 186);">SOLICITUD DE BAJA</h2>
    <div class="row">
        <div class="col-12">
            <input type="text" class="boxedfield validatemodal dbasebaja Nombre" id="Nombre" name="Nombre" placeholder="Nombre" />
        </div>
        <div class="col-12">
            <input type="text" class="boxedfield validatemodal dbasebaja Apellido" id="Apellido" name="Apellido" placeholder="Apellido" />
        </div>
        <div class="col-12">
            <input type="text" class="boxedfield validatemodal dbasebaja DNI" id="DNI" name="DNI" placeholder="DNI" />
        </div>
        <div class="col-12">
            <input type="text" class="boxedfield validatemodal dbasebaja Telefono" id="Telefono" name="Telefono" placeholder="Teléfono celular" />
        </div>
        <div class="col-12">
            <input type="text" class="boxedfield validatemodal dbasebaja Email" id="Email" name="Email" placeholder="Email" />
        </div>
        <div class="col-12">
        ...
        <div class="col-12 mt-3">
            <textarea class="boxedfield validatemodal dbasebaja Motivo" id="Motivo" name="Motivo" placeholder="Motivo de la baja"></textarea>
        </div>
    </div>
...
<script>
    ...
    $.getScript(_server + '/application/views/mod_club_redondo/baja/form.js', function() {

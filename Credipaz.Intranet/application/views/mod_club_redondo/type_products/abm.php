...
$html.=getInput($parameters,array("col"=>"col-md-7","name"=>"description","type"=>"text","class"=>"form-control text dbase validate"));
$html.=getInput($parameters,array("col"=>"col-md-2","name"=>"priority","type"=>"number","class"=>"form-control number dbase validate priority"));
$html.="</div>";

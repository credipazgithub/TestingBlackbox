if ('serviceWorker' in navigator) {
    ...
    window.addEventListener('beforeinstallprompt', (e) => {
        ...
        if (!_NMF._bInstalling && _HTTPREQUEST._mobile) {
            ...
            var _html = "<div class='container text-center p-3 m-0 colorBack' style='border-radius:25px;'><img src='img/Credipaz/logo.png' class='img-logo' alt='Logo' style='width:150px;'/></div>";
            _html += "<hr/>";
